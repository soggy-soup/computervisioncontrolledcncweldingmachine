...
class process_img:
    ...
    def img_detect_contours(self,):
        ...
        _, self.thresh = cv2.threshold(self.gray, 110, 255, cv2.THRESH_TOZERO) #0-255, 0-black, 255-white https://docs.opencv.org/3.4/d7/d4d/tutorial_py_thresholding.html
